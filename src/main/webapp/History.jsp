...
<%@page import="com.sparks.bean.HistoryBean"%>

<%@page import="com.sparks.dao.TransactionHistory"%>
...
<th scope="col">Time</th>        
    ...
    <% TransactionHistory hb=new TransactionHistory();
    ArrayList al=hb.getAll();
